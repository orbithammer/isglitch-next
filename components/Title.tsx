...
export default function Title() {
    return (
        <div className="absolute left-[.5rem] top-[9rem] sm:left-[4.4rem] md:left-[5.5rem] lg:left-[6.5rem] xl:left-[8.3rem] 2xl:left-[11rem] sm:left-[10%] z-10 flex items-center">
